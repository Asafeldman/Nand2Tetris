...
SEGMENT_DICT = {"CONST": "constant", "ARG": "argument", 
                "LOCAL": "local", "STATIC": "static", 
                "THIS": "this", "THAT": "that", 
                "POINTER": "pointer", "TEMP": "temp"}

ARITHMETIC_DICT = {"ADD": "add", "SUB": "sub", "NEG": "neg", 
                   "EQ": "eq", "GT": "gt", "LT": "lt", "AND": "and", 
                   "OR": "or", "NOT": "not", "SHIFTLEFT": "shiftleft", 
                   "SHIFTRIGHT": "shiftright", "+": "ADD", "-": "SUB", "&": "AND", 
                   "|": "OR", "<": "LT", ">": "GT", "=": "EQ","&gt;":"GT", "&lt;":"LT", "&amp;": "AND"}
...
class VMWriter:
    ...
    def write_push(self, segment: str, index: int) -> None:
        ...
        """
        self.output.write(f"push {SEGMENT_DICT[segment]} {index}\n")
    ...
    def write_pop(self, segment: str, index: int) -> None:
        ...
        """
        self.output.write(f"pop {SEGMENT_DICT[segment]} {index}\n")
    ...
    def write_arithmetic(self, command: str) -> None:
        ...
        """
        self.output.write(f"{ARITHMETIC_DICT[command]}\n")
